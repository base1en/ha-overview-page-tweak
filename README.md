...
installation using the [Home Assistant OpenCode integration](https://github.com/magnusoverli/opencode), and the MCP access it provides as the development tool.
